...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box} html,body{height:100%; margin:0}
    ...
    .btn{ display:inline-block; padding:6px 12px; background:#2563eb; color:#fff; text-decoration:none; border-radius:6px; font-size:13px; font-weight:500; margin-right:6px; }
      ...
      <table>
        ...
        %>
              <tr>
                ...
                <td><a href="ownerEditComplaint.jsp?complaintId=<%=complaint.getComplaintId()%>" class="btn">Edit Status</a></td>
              </tr>
        <%
            }
          } else {
