...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box} html,body{height:100%; margin:0}
    ...
    .btn-action{ display:inline-block; padding:6px 10px; background:#2563eb; color:#fff; text-decoration:none; border-radius:6px; font-size:12px; font-weight:500; margin-right:4px; }
              ...
              <tr>
                ...
                <td>
                  <% if(complaint.getStatus().equals("Pending")) { %>
                    <a href="userEditComplaint.jsp?complaintId=<%= complaint.getComplaintId() %>" class="btn-action">Edit</a>
                    <a href="userDeleteComplaint?complaintId=<%= complaint.getComplaintId() %>" class="btn-action btn-delete" onclick="return confirm('Are you sure you want to delete this complaint?')">Delete</a>
                  <% } else { %>
